 ...
 */
public final class AudioSourceCompat {
    float playSpeed = 1f;
    String filePath;
    long startTimeMs;
    long endTimeMs;
    ...
    public AudioSourceCompat(String filePath) {
    ...
    public void prepare() {
        try {
            ...
            throw new RuntimeException("AudioSourceCompat prepareVideo failed.", e);
        }
    }
    ...
    private long render(long positionUs) {
        ...
        while (!decoded && !ended) {
            ...
            if (inputIndex >= 0) {
                ...
                Log.w("AudioSourceCompat", "doRender: cannot dequeue input buffer from decoder");
                continue;
            }
            ...
            switch (outputIndex) {
                ...
                default:
                    ...
                    decoded = true;
//                    Log.d("AudioSourceCompat", "doRender: rendered a buffer " + this.presentationTimeUs + ", " + positionUs);
                    break;
            }
        }
        if (decoded) {
