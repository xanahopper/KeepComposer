 ...
 */
public class PatternRandomScriptActivity extends SampleActivity implements Handler.Callback, OverlayProvider, TextureView.SurfaceTextureListener, MediaComposer.PlayEventListener {
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surface, int width, int height) {
        ...
        String scriptText = OpenGlUtils.readShaderFromRawResource(R.raw.pattern_random);
