...
//        item1.setEndTimeMs(TimeUtil.secToMs(9));
        ...
        item1.setEndTimeMs(TimeUtil.secToMs(2));
        VideoItem item2 = new VideoItem(SourceProvider.VIDEO_SRC[1]);
        item2.setStartTimeMs(TimeUtil.secToMs(2));
        item2.setEndTimeMs(TimeUtil.secToMs(4));
...
//        videoTrack.addMediaItem(item1);
        ...
        TransitionItem transitionItem1 = new TransitionItem(item1, item2, 4000, 1);
